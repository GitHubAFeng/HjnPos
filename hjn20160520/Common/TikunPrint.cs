...
namespace hjn20160520.Common
{
    class TikunPrint
    {
        private string ticode = ""; //提款流水号
        private string tiren = ""; //提款人
        private string tije = ""; //提款金额
        ...
        public TikunPrint(string ticode, string tiren,string tije,string title2 = "前台中途提款凭证")
        {
            this.ticode = ticode;
            this.tiren = tiren;
            this.tije = tije;
        ...
        private string GetPrintStr()
        {
            ...
            sb.Append("= = = = = = = = = = = = = = = = = = = =\n");
            sb.Append("  提款流水: " + ticode + "\n");
            sb.Append("  分 店 号: " + HandoverModel.GetInstance.scode.ToString() + "\t" + "    " + "终端号: " + HandoverModel.GetInstance.bcode.ToString() + "\n");
            sb.Append("  操 作 员: " + HandoverModel.GetInstance.userName + "(" + HandoverModel.GetInstance.userID.ToString() + ")" + "\n");
            sb.Append("  提 款 人: " + tiren + "\n");
            sb.Append("  提款金额: " + tije + "\n");
            sb.Append("  操作时间: " + date_ + "\n");
